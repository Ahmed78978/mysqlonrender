...
mysqld --upgrade=MINIMAL --skip-grant-tables --skip-host-cache --skip-name-resolve --skip-add-locks --skip-slave-start --skip-show-database --skip-log-bin --skip-log-slave-updates --skip-auto-rehash --skip-external-locking --skip-innodb
